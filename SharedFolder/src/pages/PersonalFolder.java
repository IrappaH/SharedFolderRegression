...
public class PersonalFolder extends BasePage {
	...
	public UIControl SelectFileMovetoOtherpersonalFolder() throws Exception {
		return this.uiControl("selectFileMovetoOtherPersonalFolder");
	}
	...
	public PersonalFolderRename gotoPersonalFolderRename() throws Exception {
		this.uiControl("folderOperationMenu").click();
		return new PersonalFolderRename(this.getDriver());
	}
	
	public PersonalFolderRename gotoPersonalFileRename() throws Exception {
	...
	public UIControl checkReturnBtn() throws Exception {
		return this.uiControl("checkReturnBtn");
	}
