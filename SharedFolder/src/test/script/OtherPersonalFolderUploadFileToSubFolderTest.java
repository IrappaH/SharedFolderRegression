...
public class OtherPersonalFolderUploadFileToSubFolderTest extends InitialTestSetup {
	private OtherUserPersonalFolder otherpersonalFolder = null;
	private OtherUserPersonalFolderCreation otherpersonalFolderCreation = null;
	...
	public void login(ITestContext context) throws Exception {
		...
		Thread.sleep(2000);
		otherpersonalFolderCreation = otherpersonalFolder.gotoOtherUserPersonalFolderCreation();
		otherpersonalFolderCreation.createFolder("AutoTest1");
	}

	@BeforeMethod(alwaysRun = true)
	public void verifyFolderIsEmpty() throws Exception {
		
		otherpersonalFolder.uiControl("openRootFolder").click();
		Thread.sleep(8000);
	...
	public void deleteAllFolders() throws Exception {
		...
		if ((otherpersonalFolder.uiControl("noData").getText().trim())
			...
			otherpersonalFolder.uiControl("breadcrumRoot").click();
			...
			deleteFolder.okBtn().click();
			Thread.sleep(2000);
			// assertEquals(otherpersonalFolder.uiControl("noData").getText(),
	...
	public void verifyUploadButtonToolTipsIsDisplayed() throws Exception {
		...
		// assertEquals(otherpersonalFolder.tooltips().getText(), "upload");
	...
	// Image files
		...
		public void verifyPDFFileUpload() throws Exception {
			...
			otherpersonalFolder.uploadFileWithRobot("File.pdf");
			Thread.sleep(8000);
			// otherpersonalFolder.gotoSearchotherpersonalFolder("Single.pdf");
	...
	public void verifyBMPFileUpload() throws Exception {
		...
		otherpersonalFolder.uploadBtn().click();
		otherpersonalFolder.uploadFileWithRobot(projectPath + "\\PNGFiles\\Image type\\");
		otherpersonalFolder.uploadFileWithRobot("File.BMP");
		Thread.sleep(8000);
		// otherpersonalFolder.gotoSearchotherpersonalFolder("Single.pdf");
