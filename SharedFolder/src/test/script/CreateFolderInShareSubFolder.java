...
public class CreateFolderInShareSubFolder extends InitialTestSetup implements Autoutil {
	...
	public void verify84LengthKataganaCharFolderIsCreatedSingleByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length Katagana 84 characters of single byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verify84LengthKataganaCharFolderIsCreatedMultiByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length Katagana 84 characters of multi byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verify84LengthSymbolsCharFolderIsCreatedMultiByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length Symbols 84 characters of multi byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verify85LengthEngCharFolderIsCreatedSingleByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length English 85 characters of single byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verify85LengthEngCharFolderIsCreatedMultiByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length English 85 characters of multi byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verify85LengthKataganaCharFolderIsCreatedSingleByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length Katagana 85 characters of single byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verify85LengthKataganaCharFolderIsCreatedMultiByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length Katagana 85 characters of multi byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verify85LengthHiraganaCharFolderIsCreatedMultiByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length Hiragana 85 characters of multi byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verify85LengthKanjiCharFolderIsCreatedMultiByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length Kanji 85 characters of multi byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verify85LengthSymbolsCharFolderIsCreatedMultiByte() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name length Symbols 85 characters of multi byte in the sub folder.Folder should be created ");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForBackSlash() throws Exception {
		setTestDesc(
				"Verify that unsupported characters to create folder in sub folder '\' (half-width backslash).Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForFontSlash() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder '/'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
		sharedFolderCreation.createFolder("/\"/");
		assertEquals(sharedFolder.errorMsginvalid().getText(), getLocalizedMessage("CreateErrorMgs"));
		sharedFolder.errorMsgOkBtn().click();
	...
	public void verifyErrorMsgIsDisplayedForDoubleQuotes() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'DoubleQuotes'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
		sharedFolderCreation.createFolder("/\"/");
		assertEquals(sharedFolder.errorMsginvalid().getText(), getLocalizedMessage("CreateErrorMgs"));
		sharedFolder.errorMsgOkBtn().click();
	...
	public void verifyErrorMsgIsDisplayedForLessThan() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LessThan'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
		sharedFolderCreation.createFolder("<");
		assertEquals(sharedFolder.errorMsginvalid().getText(), getLocalizedMessage("CreateErrorMgs"));
		sharedFolder.errorMsgOkBtn().click();
	...
	public void verifyErrorMsgIsDisplayedForGreaterThan() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'GreaterThan'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
		sharedFolderCreation.createFolder(">");
		assertEquals(sharedFolder.errorMsginvalid().getText(), getLocalizedMessage("CreateErrorMgs"));
		sharedFolder.errorMsgOkBtn().click();
	...
	public void verifyErrorMsgIsDisplayedForremote_access_backup() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder '.remote_access_backup'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedFortrashbox() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'trashbox'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForsnapshot() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder '.snapshot'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForsnapshots() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder '.snapshots'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCON() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'CON'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForPRN() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'PRN'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForAUX() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'AUX'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForNUL() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'NUL'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCLOCK$() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'CLOCK$'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM0() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM0'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM1() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM1'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM2() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM2'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM3() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM3'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM4() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM4'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM5() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM5'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM6() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM6'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM7() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM7'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM8() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM8'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForCOM9() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'COM9'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT0() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT0'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT1() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT1'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT2() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT2'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT3() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT3'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT4() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT4'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT5() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT5'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT6() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT6'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT7() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT7'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT8() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT8'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForLPT9() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'LPT9'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForNameEndindWithDot() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'Name ending with '.'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
	...
	public void verifyErrorMsgIsDisplayedForNameEndingWithHalfWidthSpace() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'Name ending with half-width space'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
		sharedFolderCreation.createFolder("Test.pdf ");
		assertEquals(sharedFolder.errorMsg().getText(), getLocalizedMessage("CreateErrorMgsWith406"));
		sharedFolder.errorMsgOkBtn().click();
	...
	public void verifyErrorMsgIsDisplayedForNameStartingWithHalfWidthSpace() throws Exception {
		setTestDesc("Verify that unsupported characters to create folder in sub folder 'Name starting with half-width space'.Error message should be display.");
		sharedFolderCreation = sharedFolder.gotoSharedFolderCreation();
		sharedFolderCreation.createFolder(" Test.pdf");
		assertEquals(sharedFolder.errorMsg().getText(), getLocalizedMessage("CreateErrorMgsWith406"));
		sharedFolder.errorMsgOkBtn().click();
