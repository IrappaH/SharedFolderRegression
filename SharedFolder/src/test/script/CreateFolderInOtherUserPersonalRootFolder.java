...
public class CreateFolderInOtherUserPersonalRootFolder extends InitialTestSetup {
	...
	public void verifyFolderIsCreated() throws Exception {
		...
		personalFolderCreation = otherpersonalFolder.gotoPersonalFolderCreation();
	...
	public void verifySpecialCharFolderIsCreated() throws Exception {
		...
		assertEquals(otherpersonalFolder.firstRowName().getText(), "@#$");
	}
	...
	@Test(groups = { "CreateFolder" }, alwaysRun = false)
	@PriorityInClass(9)
	...
	public void verifyErrorMsgIsDisplayedForBackSlash() throws Exception {
		...
		personalFolderCreation = otherpersonalFolder.gotoPersonalFolderCreation();
		personalFolderCreation.createFolder("\\");
		assertEquals(otherpersonalFolder.errorMsginvalid().getText(), getLocalizedMessage("CreateErrorMgs"));
	...
	public void verifyErrorMsgIsDisplayedForremote_access_backup() throws Exception {
		...
		assertEquals(otherpersonalFolder.errorMsg().getText(), getLocalizedMessage("CreateErrorMgsWith406"));
		otherpersonalFolder.errorMsgOkBtn().click();
